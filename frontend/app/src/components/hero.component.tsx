  ...
  return (
    <section className="bg-[#1d1f22] text-white">
      <div className="container flex flex-row gap-10 justify-between items-center">
        <div className="py-6 w-full cursor-pointer">
          <Link to="https://store.steampowered.com/">
            <img
              src="../../img/hero.webp"
              alt="hero"
              className="h-auto w-full transition-transform duration-700 ease-in-out transform hover:scale-105 hover:shadow-lg"
            />
          </Link>
        </div>
